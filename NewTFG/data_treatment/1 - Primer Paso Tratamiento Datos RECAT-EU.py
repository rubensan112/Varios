...
features = pd.read_csv('../original_data/datosTFG.csv', delimiter=';')
...
#features.drop("CallSign", "FlowsADEP", "FlowsEngine", "FlowsALDT")
...
features["RECAT"] = cat_list


features.to_pickle("data/firstRECAT-EU.pkl")


if (os.path.exists("data/firstRECAT-EU.csv")):
    os.remove("data/firstRECAT-EU.csv")

f = open("data/firstRECAT-EU.csv","w")
